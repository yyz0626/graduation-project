...
module.exports = {
  ...
  async publishDynamic(ctx) {
    let { d_title, d_type, d_content, d_fk_uId, d_pictures, d_fk_uName } =
      ctx.request.body;
  ...
  async updateDynamic(ctx) {
    let { d_id, d_title, d_type, d_content, d_pictures } = ctx.request.body;
  ...
  async getAllHelpInfos(ctx) {
    let { help_fk_uId } = ctx.request.body;
